...
#
# Created: Mon Dec 31 15:25:37 2012
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout_2 = QtGui.QHBoxLayout(self.boxCurves)
        ...
        self.label_1 = QtGui.QLabel(self.boxCurves)
        self.label_1.setObjectName(_fromUtf8("label_1"))
        self.gridLayout.addWidget(self.label_1, 1, 0, 1, 1)
        self.curveResolution = QtGui.QDoubleSpinBox(self.boxCurves)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.verticalLayout_2 = QtGui.QVBoxLayout(self.boxFunctions)
        self.verticalLayout_2.setContentsMargins(-1, -1, 2, 0)
        ...
        self.coordSystem.addItem(_fromUtf8(""))
        self.formLayout.setWidget(0, QtGui.QFormLayout.FieldRole, self.coordSystem)
        ...
        self.formLayout.setWidget(3, QtGui.QFormLayout.FieldRole, self.lineEditX)
        ...
        self.formLayout.setWidget(4, QtGui.QFormLayout.FieldRole, self.lineEditY)
